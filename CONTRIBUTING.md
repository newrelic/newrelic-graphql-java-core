# Contributing to newrelic-graphql-java-core
Thanks for your interest in contributing! We look forward to engaging with you.
...
* Any modifications made to this library
...
If you can build the project, you can develop it!
...
You can run all of the tests, and verify that your code is formatted correctly by running

`./gradlew check`

## License
By contributing to newrelic-graphql-java-core, you agree that your contributions will be licensed under the [License file](LICENSE) 
